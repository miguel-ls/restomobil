...
-- 5. Poblar la tabla `categorias_producto` y `productos`
INSERT IGNORE INTO `categorias_producto` (`id`, `nombre`, `descripcion`) VALUES (1, 'Bebidas', 'Bebidas frías y calientes');
INSERT IGNORE INTO `productos` (`id`, `nombre`, `descripcion`, `precio`, `id_categoria`, `disponible`) VALUES (1, 'Gaseosa Inka Kola 500ml', 'Gaseosa personal', 3.50, 1, 1);

-- 6. Poblar la tabla `unidades_medida`
INSERT IGNORE INTO `unidades_medida` (`codigo`, `descripcion`, `estado`) VALUES
('NIU', 'Unidad (Bienes)', 1),
('KGM', 'Kilogramo', 1),
('LBR', 'Libra', 1),
('LTR', 'Litro', 1);