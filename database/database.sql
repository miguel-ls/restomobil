...
-- Script date 08/10/2025 00:11:59
...
CREATE
DEFINER = 'miguel'@'localhost'
PROCEDURE sp_updateProduct (IN p_id int, IN p_nombre varchar(100), IN p_descripcion text, IN p_precio decimal(10, 2), IN p_id_categoria int, IN p_estado enum ('activo', 'inactivo'))
BEGIN
  UPDATE productos
  SET nombre = p_nombre,
      descripcion = p_descripcion,
...
CREATE
DEFINER = 'miguel'@'localhost'
PROCEDURE sp_createProduct (IN p_nombre varchar(100), IN p_descripcion text, IN p_precio decimal(10, 2), IN p_id_categoria int, IN p_estado enum ('activo', 'inactivo'))
BEGIN
...
(2, '2025', '10', 'E', 2, '2025-10-07', 1, 'F001', '00000002', 'P', NULL, 1, 'Activado', '2025-10-06 23:39:36', '2025-10-07 16:16:54', 2),
(3, '2025', '10', 'E', 2, '2025-10-07', 1, 'F001', '00000001', 'P', NULL, 1, 'Activado', '2025-10-07 14:48:49', '2025-10-07 14:49:39', 1),
(4, '2025', '10', 'E', 3, '2025-10-07', 5, 'F001', '00000008', 'P', NULL, 1, 'Activado', '2025-10-07 16:28:53', '2025-10-07 16:28:53', 2);
...
(1, 'LOMO SALTADO', '', 25.00, 1, NULL, 'activo'),
(2, 'ARROZ CON POLLO', '', 25.00, 1, NULL, 'activo'),
(3, 'PAPA RELLENA', '', 10.00, 1, NULL, 'activo'),
(4, 'POLLO AL CILINDRO', '', 30.00, 1, NULL, 'activo'),
(5, 'CAJA CHINA', '', 30.00, 1, NULL, 'activo'),
(6, 'INKA COLA PERSONAL', '', 5.00, 4, NULL, 'activo'),
(7, 'INKA COLA 1.5 LITROS', '', 10.00, 4, NULL, 'activo'),
(8, 'INKA COLA 3 LITROS', '', 20.00, 4, NULL, 'activo'),
(9, 'TRES LECHES', '', 10.00, 3, NULL, 'activo'),
(10, 'PIE DE MANZANA', '', 10.00, 3, NULL, 'activo'),
(11, 'CAPUCCINO (1 TAZA)', '', 10.00, 2, NULL, 'activo'),
(12, 'VARIOS', '', 0.00, 5, NULL, 'activo');
