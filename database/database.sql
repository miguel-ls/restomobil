...
-- Script date 08/10/2025 21:41:25
...
--
-- Drop procedure `sp_crear_movimiento_salida_por_venta`
--
...
--
-- Drop procedure `sp_verificar_movimiento_por_pedido`
--
...
--
-- Create procedure `sp_verificar_movimiento_por_pedido`
--
CREATE
DEFINER = 'miguel'@'%'
PROCEDURE sp_verificar_movimiento_por_pedido (IN p_id_pedido int)
BEGIN
  SELECT
    COUNT(id) AS movimiento_existente
  FROM movimientos
  WHERE id_pedido = p_id_pedido
...
--
-- Create procedure `sp_crear_movimiento_salida_por_venta`
--
CREATE
DEFINER = 'miguel'@'%'
PROCEDURE sp_crear_movimiento_salida_por_venta (IN p_id_pedido int)
BEGIN
  ...
  SELECT
    ...
    DATE(fecha_creacion),
    id_cliente INTO v_anio, v_periodo, v_fecha_movimiento, v_id_cliente
  FROM pedidos
  WHERE id = p_id_pedido;

  -- Obtener el almacén predeterminado
  SELECT
    id INTO v_id_almacen
  FROM almacenes
  WHERE predeterminado = 1 LIMIT 1;

  START TRANSACTION;

    -- Insertar la cabecera del movimiento
    INSERT INTO movimientos (anio, periodo, tipo_movimiento, codigo_movimiento, fecha_movimiento,
  ...
  read_loop:
    LOOP
      ...
      INSERT INTO movimientos_detalle (id_movimiento, item, id_producto, cantidad, id_producto_padre,
...
(24, 1, 2, 'completado', 70.00, '2025-10-08 18:05:26', '2025-10-08 20:34:13', 15, NULL, NULL, '00000002');
...
(5, '2025', '10', 'S', 4, '2025-10-08', 6, '0000', '20251008', 'C', 15, NULL, 'Activado', '2025-10-08 20:18:16', '2025-10-08 20:18:16', 1, 24);
...
(5, 216, 15, 2.00000, NULL, NULL, 'VINO SANTIAGO QUEIROLO 750 ML', 'NIU', 0.00000, 0.00000, NULL);
...
(10, '2025-10-09 03:18:00', '2025-10-09', 'apertura', 250.00, '', 1, '2025-10-08 20:18:10', '2025-10-08 20:18:10');
