...
<div class="dashboard-container">
    ...
    <main class="main-content">
        <div class="container">
            ...
            <form action="cliente_handler.php" method="POST" class="form-container">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group-inline">
                        ...
                        <div class="input-with-button">
                            <input type="text" id="numero_documento" name="numero_documento" value="<?php echo htmlspecialchars($cliente['numero_documento']); ?>" required>
