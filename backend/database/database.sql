...
-- Script date 07/10/2025 17:12:58
...
CREATE
DEFINER = 'miguel'@'localhost'
PROCEDURE sp_updateOrderStatus (IN `p_id_pedido` int, IN `p_estado` varchar(50))
BEGIN
  UPDATE pedidos
  SET estado = p_estado,
...
BEGIN
  ...
  OR m.tipo_movimiento COLLATE utf8mb4_unicode_ci = p_tipo_movimiento COLLATE utf8mb4_unicode_ci)



  AND (p_tipo_entidad IS NULL
  OR p_tipo_entidad = ''
  OR m.tipo_entidad COLLATE utf8mb4_unicode_ci = p_tipo_entidad COLLATE utf8mb4_unicode_ci)
...
BEGIN
  ...
  /*
    ...
    OR p_id_almacen = ''
    OR m.id_almacen COLLATE utf8mb4_unicode_ci = p_id_almacen COLLATE utf8mb4_unicode_ci)
  */
...
(22, 1, 2, 'pagado', 55.00, '2025-10-02 18:35:18', '2025-10-02 18:35:44', 15, 2, 2, '00000010'),
(23, 1, 2, 'pagado', 65.00, '2025-10-02 19:12:43', '2025-10-02 19:16:38', NULL, NULL, NULL, NULL);
...
(1, 'PRINCIPAL', 1, '2025-10-07 09:54:23', '2025-10-07 09:54:23', NULL),
(2, 'SECUNDARIO', 1, '2025-10-07 09:54:30', '2025-10-07 09:54:30', NULL);
...
(18, 22, 15, 1, 2, 2, '00000010', 55.00, 10.00, 50.00, 5.00, 'emitida', '2025-10-02 18:35:44'),
(19, 23, NULL, 1, 2, 2, '00000011', 65.00, 10.00, 59.09, 5.91, 'emitida', '2025-10-02 19:16:38');
