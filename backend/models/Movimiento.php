...
class Movimiento {
    ...
    public function getAll($filter, $limit, $offset) {
        $stmt = $this->conn->prepare("CALL sp_read_movimientos(:p_filter, :p_limit, :p_offset)");
    ...
    public function count($filter) {
        $stmt = $this->conn->prepare("CALL sp_count_movimientos(:p_filter)");
        $stmt->bindParam(':p_filter', $filter, PDO::PARAM_STR);
        $stmt->execute();
