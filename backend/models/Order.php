...
class Order {
    ...
    public function create($id_mesa, $id_usuario_mozo, $items, $estado = 'abierto', $id_cliente = null, $id_tipo_documento_venta = null, $id_serie_documento = null, $numero_documento = null) {
