-- Migration to add Empresa and Ubigeo tables and procedures
...
CREATE TABLE IF NOT EXISTS `ubigeo_provincias` (
  ...
  FOREIGN KEY (`id_departamento`) REFERENCES `ubigeo_departamentos`(`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

INSERT INTO `ubigeo_provincias` (`id`, `nombre`, `id_departamento`) VALUES
('0101', 'Chachapoyas', '01'),
('0102', 'Bagua', '01'),
('0103', 'Bongará', '01'),
...
CREATE TABLE IF NOT EXISTS `ubigeo_distritos` (
  ...
  FOREIGN KEY (`id_provincia`) REFERENCES `ubigeo_provincias`(`id`),
  FOREIGN KEY (`id_departamento`) REFERENCES `ubigeo_departamentos`(`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

INSERT INTO `ubigeo_distritos` (`id`, `nombre`, `id_provincia`, `id_departamento`) VALUES
...
CREATE TABLE IF NOT EXISTS `empresas` (
  ...
  `sunat_envio_estado` BOOLEAN NOT NULL DEFAULT FALSE,
  `sunat_api_url` VARCHAR(255),
  `sunat_api_key` VARCHAR(255),
  FOREIGN KEY (`id_departamento`) REFERENCES `ubigeo_departamentos`(`id`),
  FOREIGN KEY (`id_provincia`) REFERENCES `ubigeo_provincias`(`id`),
  FOREIGN KEY (`id_distrito`) REFERENCES `ubigeo_distritos`(`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- -----------------------------------------------------
-- Stored Procedures for Ubigeo
-- -----------------------------------------------------
DELIMITER $$
...
-- -----------------------------------------------------
-- Stored Procedures for `empresas`
-- -----------------------------------------------------

DROP PROCEDURE IF EXISTS `sp_getAllEmpresas`$$
CREATE PROCEDURE `sp_getAllEmpresas`()
BEGIN
    SELECT id, nombre_corto, ruc, estado FROM `empresas` ORDER BY nombre_corto;
END$$

DROP PROCEDURE IF EXISTS `sp_getOneEmpresa`$$
CREATE PROCEDURE `sp_getOneEmpresa`(IN p_id INT)
BEGIN
...
CREATE PROCEDURE `sp_deleteEmpresa`(IN p_id INT)
BEGIN
